...
public class DialogoCambiarNota2 extends JDialog implements ActionListener{
	/**
     ...
     */
    public DialogoCambiarNota2( InterfazAppCalificaciones pPrincipal, Estudiante est )
    {
        principal = pPrincipal;
        estudiante = est;
        setTitle( "Ingrese la nota 2" );
        setSize( 250, 120 );
        ...
        JLabel etiquetaNombre = new JLabel( "Nota 2:" );
    ...
    public void actionPerformed( ActionEvent pEvento )
    {
        ...
        {   
         ...
         try{
            ...
            {
                JOptionPane.showMessageDialog( this, "Debe ingresar todos los datos correctamente.", "Buscar", JOptionPane.ERROR_MESSAGE );
            }
            else
            {
                principal.reqFuncOpcion5( strCodigo, estudiante);
                dispose( );
            }
         }
         catch(Exception e)
